...
#undef WILDSTACKS_DEFAULT_LOG_CATEGORY
#define WILDSTACKS_DEFAULT_LOG_CATEGORY "openwildstacks"
...
CurrentBlockchainStatus::update_current_blockchain_height()
{
    ...
    // but it also serves as a "ping" into the WildStacks
    // deamon to keep the connection between the
    // openwildstacks backend and the deamon alive
...
bool
CurrentBlockchainStatus::init_wildstacks_blockchain()
{
