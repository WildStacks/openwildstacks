 ...
 * avaliable in the wildstacks itself, but which was dropped.
 *
...
public:
    ...
    // in wildstacks, but due to recent changes in 2018 09,
    // they were removed. However, parts of openwildstacks
    // require them.
    struct out_entry
    {
