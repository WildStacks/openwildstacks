...
#ifndef RESTBED_XMR_YOURWILDSTACKSREQUESTS_H
#define RESTBED_XMR_YOURWILDSTACKSREQUESTS_H
...
#define MAKE_RESOURCE(name) auto name = open_wildstacks.make_resource( \
                           &xmreg::OpenWildstacksRequests::name, "/" + string(#name));
#endif
...
#define OPENWILDSTACKS_RPC_VERSION_MAJOR 1
#define OPENWILDSTACKS_RPC_VERSION_MINOR 6
#define MAKE_OPENWILDSTACKS_RPC_VERSION(major,minor) (((major)<<16)|(minor))
#define OPENWILDSTACKS_RPC_VERSION \
    MAKE_OPENWILDSTACKS_RPC_VERSION(OPENWILDSTACKS_RPC_VERSION_MAJOR, OPENWILDSTACKS_RPC_VERSION_MINOR)
...
public:
    ...
    OpenWildstacksRequests(shared_ptr<MySqlAccounts> _acc,
    ...
    shared_ptr<Resource>
    make_resource(function< void (OpenWildstacksRequests&, const shared_ptr< Session >, const Bytes& ) > handle_func,
                  const string& path);
...
#endif //RESTBED_XMR_YOURWILDSTACKSREQUESTS_H
